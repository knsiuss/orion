 ...
 * @description Assembles the full LLM system prompt for each conversation turn.
 *
 * ARCHITECTURE / INTEGRATION:
 *   Injects workspace identity (SOUL.md, AGENTS.md), persona fragments, memory
 *   context, and user-preference overrides in the order defined by OpenClaw.
 */
